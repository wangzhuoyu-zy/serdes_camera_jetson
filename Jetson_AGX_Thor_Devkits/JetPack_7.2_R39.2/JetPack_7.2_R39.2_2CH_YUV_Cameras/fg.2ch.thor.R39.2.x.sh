...
<<COMMENT
#
# 2026-07-08 AGX Thor (P3971) FG96-2CH YUV 4-Lane camera firmware install script
#                  JetPack R39.2 / L4T R39.2 / kernel 6.8.12-1021-tegra
# 重命名为：fg.2ch.thor.R39.2.x.sh
COMMENT
...
red_print "------------AGX Thor FG96-2CH YUV 4-Lane Firmware Upgrade 固件升级----------------------"
echo ''
...
#    overlay-name = "Jetson Camera Thor_FG96_2CH"  (与 jetson-io 注册名一致)
#
#    原 Orin 脚本里用的是：
#      tegra234-p3767-camera-p3768-fzcam-fg96-2ch-4lanes.dtbo   ← 已不存在
#      /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Camera FG96-2CH-4Lanes-YUV"
#    Thor 上 overlay-name 改成 "Jetson Camera Thor_FG96_2CH" 才能匹配 dtbo。
# ---------------------------------------------------------------------------
DTBO_SRC=rootfs/boot/tegra264-p3971-camera-fg-2ch-overlay.dtbo
DTBO_DST=/boot/tegra264-p3971-camera-fg-2ch-overlay.dtbo
