...
Directory: JetPack_6.2.1_R36.4.4_7_2CH_YUV_Cameras
...
```bash
scp -r JetPack_6.2.1_R36.4.4_7_2CH_YUV_Cameras nvidia@<JETSON_IP>:
```
...
```bash
cd ~/JetPack_6.2.1_R36.4.4_7_2CH_YUV_Cameras
