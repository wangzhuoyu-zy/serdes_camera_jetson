...
sudo cp rootfs/boot/tegra234-p3767-camera-p3768-fzcam-fg96-2ch-4lanes.dtbo /boot/
sudo /opt/nvidia/jetson-io/config-by-hardware.py -n 2="Camera FG96-2CH-4Lanes-YUV"
