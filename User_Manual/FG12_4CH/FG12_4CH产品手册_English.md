# FG12_4CH GMSL Camera Platform Product Manual
...
FG12_4CH GMSL Camera Platform is an expansion board that allows up to 4 cameras to connect to Jetson AGX Orin/Xavier modules. It is fully compatible with NVIDIA Jetson AGX Orin/Xavier development kits.

### Product Introduction

●  FG 12_4CH GMSL Board is a 4-channel GMSL  capture  board  developed  by  Zhuying  Intelligent /  Fangzhu  Technology based on the ADI Deserializer chip MAX96712, hereinafter referred to as the Capture Board.
●  This capture board can connect up to 4 GMSL cameras simultaneously and output  CSI  signals  to the NVIDIA®  Jetson
Orin™ NX Development Kit (it can also be connected to the Xavier NX Development Kit).
●  Through software configuration, the MAX96712 can adaptively decode GMSL cameras with different rates of GMSL1 andGMSL2 protocols.
●The 22Pin connector on the NVIDIA Jetson® Orin/Xavier™ NX Development Kit cannot supply the power required by the cameras. Therefore, the capture board is equipped with a pluggable external DC  power  connector for 12V~24V  input(  the same power adapter as the kit can be used).
...
![Product Image 1](../images/FG12_4CH/pic1.png)

![Product Image 2](../images/FG12_4CH/pic2.png)

![Product Image 3](../images/FG12_4CH/pic3.png)
...
| Camera Inputs | 4-channel GMSL2 or GMSL1 cameras (RGB/RGBD compatible) |
| Deserializer | ADI MAX96712 |
| MIPI Output | CSI-2 v1.3 |
| Camera Connector | Single-end vertical FAKRA connector |
| PoC Power Supply | 4-channel camera power, PoC 12V |
...
- The FG12_4CH carrier board supports input voltage range: 12V~24V, current: 2A or above
...
![Block Diagram](../images/FG12_4CH/block_diagram.png)
...
![Component Placement](../images/FG12_4CH/component_placement.png)
...
| No. | Name | ID | Remarks |
|-----|------|-----|---------|
| 1 | Power Input | J1 | 12V~24V DC input |
| 2 | CAM0 | J2 | FAKRA coaxial connector |
| 3 | CAM1 | J3 | FAKRA coaxial connector |
| 4 | CAM2 | J4 | FAKRA coaxial connector |
| 5 | CAM3 | J5 | FAKRA coaxial connector |
| 6 | External Trigger | J11 | 2.54-2*3P |
| 7 | CSI0 | J12 | Molex 22Pin ZIF (4Lane CSI) |
| 8 | CSI1 | J13 | Molex 22Pin ZIF (4Lane CSI) |
...
### 7.2 J11 - External Trigger Signal Connector
...
Connect according to product image. CAM interface corresponds to CAM5~8 configuration. Run `sudo fzcam_ui` to configure CAM5~8, then select camera brands and models.
...
![Camera Configuration GUI](../images/FG12_4CH/camera_config_en.png)
