# FG96_2CH GMSL Camera Platform Product Manual
...
FG96-2CH GMSL Camera Platform is an expansion board that allows up to 2 cameras to connect to Jetson AGX Orin/Xavier modules.

### Product Introduction

●FG96_2CH GMSL Board is a 2-channel GMSL capture board developed by Zhuying Intelligent / Fangzhu Technology based
on the ADI Deserializer chip MAX9296A, hereinafter referred to as the Capture Board.
●This capture board supports connecting up to 2 GMSL cameras simultaneously and outputs  CSI signals to the NVIDIA®
Jetson AGX Orin™ NX Development Kit (also compatible with the Xavier NX Development Kit).
● Through software configuration, the MAX9296A can adaptively decode GMSL cameras with different rates of GMSL1 and GMSL2.
●The 22Pin connector on the NVIDIA Jetson® AGX Orin™ NX Development Kit cannot provide sufficient power for cameras.
Therefore, the capture board uses a pluggable 12V–24V DC external power connector (can share the same power adapteras the kit).
...
![Product Image 1](../images/FG96_2CH/pic1.png)

![Product Image 2](../images/FG96_2CH/pic2.png)

![Product Image 3](../images/FG96_2CH/pic3.png)
...
- The FG96_2CH carrier board supports input voltage range: 12V~24V, current: 2A or above
...
![Block Diagram](../images/FG96_2CH/block_diagram.png)
...
![Component Placement](../images/FG96_2CH/component_placement.png)
...
![Camera Configuration GUI](../images/FG96_2CH/camera_config_en.png)
