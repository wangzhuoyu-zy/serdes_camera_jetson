# FG12_12CH GMSL Camera Platform Product Manual
...
●  Through software configuration, the MAX96712 can adaptively decode GMSL cameras with different rates of GMSL1 andGMSL2 (3G/6G).
●The 120-pin connector on the NVIDIA Jetson® AGX Orin™  Devkit  cannot  supply  the  power  required  by  the  cameras.Therefore, the capture board is equipped with a pluggable external DC  power  connector  for  12V –24V  input (the samepower adapter as the kit can be used).
...
![Product Image 1](../images/FG12_12CH/pic1.png)

![Product Image 2](../images/FG12_12CH/pic2.png)
...
| Deserializer | ADI MAX96712, each deserializer接入一个4-Lane MIPI |
| MIPI Output | CSI-2 v1.3 (16-Lanes total) |
| Camera Connector | Single-end vertical FAKRA connector |
| PoC Power Supply | 8-channel camera power supplied by GMSL board, PoC 12V |
...
- The FG12_12CH carrier board supports input voltage range: 12V~24V, current: 2A or above
...
![Block Diagram](../images/FG12_12CH/block_diagram.png)
...
![Component Placement](../images/FG12_12CH/component_placement.png)

![Component Placement Diagram 2](../images/FG12_12CH/component_placement_2.png)
...
| No. | Name | ID | Remarks |
|-----|------|-----|---------|
| 1 | CAM0 | J8 | FAKRA coaxial connector, GMSL input |
| 2 | CAM1 | J9 | FAKRA coaxial connector, GMSL input |
| 3 | CAM2 | J10 | FAKRA coaxial connector, GMSL input |
| 4 | CAM3 | J11 | FAKRA coaxial connector, GMSL input |
| 5 | CAM4 | J2 | FAKRA coaxial connector, GMSL input |
| 6 | CAM5 | J3 | FAKRA coaxial connector, GMSL input |
| 7 | CAM6 | J4 | FAKRA coaxial connector, GMSL input |
| 8 | CAM7 | J5 | FAKRA coaxial connector, GMSL input |
| 9 | Power Input | J1 | Spec: HC-5557-2*2A |
| 10 | External Trigger Input | J15 | 2*3P直插 |
| 11 | BTB Connector | J14 | BTB high-speed connector |
...
### 7.2 J15 - External Trigger Signal Connector
...
### 7.2 J2/J3/J4/J5/J8/J9/J10/J11 - FAKRA Connectors

**Function:** GMSL camera interface

**ID:** J2, J3, J4, J5, J8, J9, J10, J11

**Type/Model:** Amphenol 2FA1-NZSP-PCBB6

**Description:** GMSL camera interface is based on V4L2, providing unified interface specifications for drivers and applications.
...
| GMSL4 (CAM4) | J8 | /dev/video4 |
| GMSL5 (CAM5) | J9 | /dev/video5 |
| GMSL6 (CAM6) | J10 | /dev/video6 |
| GMSL7 (CAM7) | J11 | /dev/video7 |
...
Supports dynamic camera detection and loading. Run `sudo fzcam_ui` to configure CAM0~7 (also compatible with 12-channel configuration), then select different camera brands and sensor models.
...
![Camera Configuration GUI](../images/FG12_12CH/camera_config.png)
