...
●  FG92-2CH GMSL板是竹影智能/方竹科技基于ADI Deserializer芯片MAX96718A开发的2路GMSL采集板，以下简称采集板  。
●  此采集板可同时接入至多2个GMSL相机并输出CSI信号到NVIDIA® Jetson AGX Orin™NX开发套件(亦可接于Xavier NX开发套件上)
●此采集板可通过软件配置的方式让MAX96712自适应的解析GMSL1与GMSL2不同速率的GMSL相机。
●NVIDIA Jetson® AGX Orin™/Xavier™ NX开发套件上22Pin连接器不能提供相机所需电源，因此采集板通过一个可插拔的12V-24V的DC电源外部连接器（可与套件采用同一电源适配器）

FG92-2CH GMSL相机平台是一个扩展板，允许多达2个相机连接到Jetson® AGX Orin™/Xavier™模块，它与NVIDIA Jetson® AGX Orin™/Xavier™开发套件完全兼容。自适应的工作在不同频率即通过软件配置同时兼容GMSL1与GMSL2协议接口。

易于在自主移动机器人（AMR）机器人技术、无人机（UAV）及汽车等应用中安装及使用。

### 1.1 产品图片

![产品图片1](../images/FG92_2CH/pic1.png)

![产品图片2](../images/FG92_2CH/pic2.png)

![产品图片3](../images/FG92_2CH/pic3.png)
...
- FG92_2CH载板支持输入电源范围：12V~24V，电流：2A以上
...
![产品框图](../images/FG92_2CH/block_diagram.png)
...
![位号图](../images/FG92_2CH/component_placement.png)
...
![相机配置界面](../images/FG92_2CH/camera_config_cn.png)
